  ...
  return (
    <div className="min-h-screen flex flex-col relative">
      ...
      >
        ...
        <span className="absolute right-16 bg-card text-foreground text-sm font-semibold px-3 py-1 rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none border border-border">
          Call us
        </span>
      </a>
      ...
      >
        ...
        <span className="absolute right-16 bg-card text-foreground text-sm font-semibold px-3 py-1 rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none border border-border" aria-hidden>
          Scroll to top
        </span>
      </button>
    </div>
